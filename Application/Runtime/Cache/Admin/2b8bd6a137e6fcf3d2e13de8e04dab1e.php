...
<div class="table-box">
    <table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="file"><?php echo ($vo["filename"]); ?>【<a href="/index.php/Admin/Doc/download/id/<?php echo ($vo["id"]); ?>">下载</a>】</td>
                <td class="content"><?php echo (htmlspecialchars_decode($vo["content"])); ?></td>
